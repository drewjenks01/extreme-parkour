...
python_args="--exptid phase3_ep_no_reindex_go1_teacher_actions --headless --resume_path /data/scratch-oc40/pulkitag/awj/extreme-parkour/legged_gym/logs/final_models/phase2_ep_no_reindex_go1/model_latest.pt --use_rgb --use_depth --rgb_domain_rand"
