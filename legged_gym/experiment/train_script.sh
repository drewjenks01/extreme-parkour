...
#SBATCH --job-name=ep_parkour_phase3
#SBATCH --partition=vision-pulkitag-3090,vision-pulkitag-a6000
...
python_args="--exptid phase3_ep_no_contact --headless --resume_path"
