...
python_args="--exptid phase2_go1_no_direc_rgb --headless --resume_path /data/scratch-oc40/pulkitag/awj/extreme-parkour/legged_gym/logs/parkour_new/phase2_go1_no_direc_rgb/model_9500.pt --use_rgb"
